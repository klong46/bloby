...
PLAYER_TILE = 9
PANEL_TILE = 10
PLAYER_OBSTACLES = {WALL_TILE, RIGHT_LASER_TILE, LEFT_LASER_TILE, UP_LASER_TILE, DOWN_LASER_TILE, PANEL_TILE}
GUARD_OBSTACLES =  {WALL_TILE, RIGHT_LASER_TILE, LEFT_LASER_TILE, UP_LASER_TILE, DOWN_LASER_TILE, LADDER_TILE, PANEL_TILE}
